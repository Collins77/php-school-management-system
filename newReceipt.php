...
<div class="container bg-danger">
    ...
    $sql = "insert into receipts(receipt_number,receipt_date,first_name,middle_name,last_name,course,amount_paid)
values ('$receiptNumber','$receiptDate','$firstName','$middleName','$lastName','$course','$amountPaid')";
    // Executing the query
    if ($conn->query($sql) == true){
        print "<p>Receipt Submitted</p>";
        print "<a href='receipt.php' class='btn btn-primary'>New Receipt</a>";
    }
    else{
        print "<p>An error occurred</p>";
        print "<a href='receipt.php' class='btn btn-dark'>Try Again</a>";
    }
    mysqli_close($conn);
    ?>
</body>
