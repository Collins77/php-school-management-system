...
<div class="container bg-danger">
    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            <div class="heading">
                <p class="text-left text-white">Enter Course Code to find:</p>
            </div>
            <form action="displayAdmissionU.php" method="post">
                <table class="table table-striped table-responsive-sm">
                    ...
                    <tr>
                        <td class="text-center" colspan="2">
                            ...
                            &nbsp;&nbsp;
                            <a href="admissions.php" class="btn btn-outline-primary">Cancel Search</a>
                        </td>
                    </tr>
                </table>
            </form>
