...
$sql="SELECT * FROM invoice WHERE billing_id='$BID'";
                    ...
                    <form action="updateBilling.php" method="post">
                        <table class="table table-striped table-responsive-sm">
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="BID" class="form-control" required value="<?php echo $row['billing_id']?>">
                                </td>
                            </tr>
                            <tr>
                                <td class="text-right">
                                ...
                                <td>
                                    <input type="date" name="bDate" class="form-control" required value="<?php echo $row['billing_date']?>">
                                </td>
                            </tr>
                            <tr>
                                <td class="text-right">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="pAmount" class="form-control" required value="<?php echo $row['payable_amount']?>">
                                </td>
                            </tr>
                            <tr>
                                <td class="text-center" colspan="2">
                                    ...
                                    &nbsp;&nbsp;
                                    <a href="billing.php" class="btn btn-outline-secondary">Cancel Update</a>
                                </td>
                            </tr>
                        </table>
                    </form>
